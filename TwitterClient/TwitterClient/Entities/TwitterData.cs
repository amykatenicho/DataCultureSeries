...
namespace TwitterClient
{
    ...
    public class TwitterUser
    {
        ...
        [DataMember(Name = "location")]                public string UserLocation;
    }
    ...
    public class TwitterPayload
    {
        ...
        {
            return new { ID, CreatedAt, UserName, TimeZone, ProfileImageUrl, Text, Language, Topic, Location, SentimentScore }.ToString();
        }
    }
...
//        public string RawJson;
        ...
        public override string ToString()
        {
            return new { ID, CreatedAt, UserName, Text, Topic, Language, Location, SentimentScore }.ToString();
        }
    }
